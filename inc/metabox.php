...
class RW_Meta_Box {
	...
	static function js_css() {
		...
		wp_enqueue_style('rw-meta-box', get_bloginfo('stylesheet_directory') . '/css/metabox.css');
		wp_enqueue_script('rw-meta-box', get_bloginfo('stylesheet_directory') . '/js/metabox.js', array('jquery'), NULL, true);
	}
